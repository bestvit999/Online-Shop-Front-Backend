  ...
  if(isset($_POST['save']))
{
    ...
    $sql = "UPDATE orderhistory SET PurchaseDate = '$purchasedate' WHERE OId='$oid'";
...
?>
    ...
    <form action="orderhistoryUpdate.php" method="post"> 
    <div style="text-align:center"> 
        <label id="first"> OId:</label><br/>
        <input type="text" name="OId" placeholder="輸入購買紀錄編號"><br/>
        <label id="first"> Update PurchaseDate:</label><br/>
